...
__global__ void gpu_force_sets_kernel(const Dscalar2* __restrict__ d_points,
                                      ...
                                      const Dscalar2* __restrict__ d_m,
                                      Dscalar   KA,
                                      Dscalar   KP,
                                      int     computations,
                                      Index2D n_idx,
    ...
    Adiff = d_m[pidx].x*(d_AP[pidx].x - d_APpref[pidx].x);
    Pdiff = d_m[pidx].y*(d_AP[pidx].y - d_APpref[pidx].y);
    ...
    Adiff = d_m[pidx].x*(d_AP[neighs.y].x - d_APpref[neighs.y].x);
    Pdiff = d_m[pidx].y*(d_AP[neighs.y].y - d_APpref[neighs.y].y);
    ...
    Adiff = d_m[pidx].x*(d_AP[neighs.x].x - d_APpref[neighs.x].x);
    Pdiff = d_m[pidx].y*(d_AP[neighs.x].y - d_APpref[neighs.x].y);
